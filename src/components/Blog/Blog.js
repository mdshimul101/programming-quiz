      ...
      <div className="w-10/12 m-auto">
        ...
        <div className="mt-11 mb-24 md:w-8/12">
          ...
          <p>
            ...
            or URL. It keeps track of the location and renders different Route s as it
             changes, and it also gives you tools to update the location using Link s 
             and the history API
          </p>
          <br />
          <h4 className="font-semibold text-2xl text-slate-800">
          ...
          <p>
            ...
            can hold a mutable value in its .current property. You might be
            familiar with refs primarily as a way to access the DOM. If you pass
            a ref object to React with myRef, React will set its .current
